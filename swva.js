...
AJS.toInit(function(){
  ...
  AJS.$("div.contentLayout2").prepend("<p id='edit-button' style='text-align: right;''></p>");
  AJS.$("#editPageLink").clone().prependTo($("#edit-button"));
});

window.onload = function(){
  AJS.toInit(function(){
    if (!AJS.params.cqIsAnonymous){
      console.log("is still NOT anonymous");
      AJS.$(".brikit-toolbar").css("display", "block");
    }
  });
}
